...
DXGI_FORMAT DX12Util::TranslateFormat(PixelFormat format)
{
    return DX12Util::_Formats[static_cast<u32>(format)].DXFormat;
}

D3D12_COMMAND_LIST_TYPE DX12Util::TranslateCommandType(const CommandType t)
{
...
void DX12Util::Init()
{
    ...
    DX12Util::_Formats.resize(static_cast<u32>(PixelFormat::MAX));
