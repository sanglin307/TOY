...
void ImGui_ImplDX12_SetDescriptorHeap(ImDrawData* draw_data, D3D12_GPU_DESCRIPTOR_HANDLE font_srv_gpu_desc_handle)
{
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            pcmd->TextureId = (ImTextureID)(font_srv_gpu_desc_handle.ptr);
        }
    }
}
